...
this.members=new $,this.canonicalMembers=new $,this.store=e,this.key=n.key,this.inverseKey=r,this.internalModel=t,this.isAsync=void 0===i||i,this.isPolymorphic=void 0!==o&&o,this.relationshipMeta=n,this.inverseKeyForImplicit=this.internalModel.modelName+this.key,this.fetchPromise=null,this._promiseProxy=null,this.meta=null,this.__inverseMeta=void 0,this.shouldForceReload=!1,this.relationshipIsStale=!this.isNew,this.hasAnyRelationshipData=!1,this.relationshipIsEmpty=!0,this.hasFailedLoadAttempt=!1}return e.prototype._inverseIsSync=function(){var e=this._inverseMeta
if(!e)return!1
...
if(this.shouldMakeRequest()){var r=void 0
r=(r=(r=this.link?this._fetchLink():this._fetchRecord()).then(function(){return se(e)},function(t){return se(e,t)})).then(function(e){return e?e.getRecord():null}),this.fetchPromise=r,this._updateLoadingPromise(r)}if(this.isAsync){if(null===this._promiseProxy){var n=Ember.RSVP.resolve(this.inverseInternalModel).then(function(e){return e?e.getRecord():null})
...
function se(e,t){var r=e.inverseInternalModel
...
return!(t&&null===t.inverse)}(t)&&(i=e.type.inverseFor(t.key,r)),i&&(n=i.name),"hasMany"===t.kind?new re(r,e,n,t):new oe(r,e,n,t)}(n,i,n.store),o&&r.push(o,!0)}return r},ae(e,[{key:"record",get:function(){return this.internalModel}}]),e}(),le=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r]
...
function Ce(e,t,r,n,i,o){return e.normalizeResponse(t,r,n,i,o)}function Te(e,t,r){var n=t.serializer
...
return null!==e&&"hasMany"===e.kind}}]),e}(),Ne=function(){function e(e){this._store=e,this._cache=Object.create(null),this._inverseLookupCache=new Me}return e.prototype.get=function(e,t,r){var n=this._getRelationshipPayloads(e,r,!1)
...
return(a=J(a,t,u)).then(function(n){var i=Ce(Te(t,e,r),t,s,n,null,"findMany")
return t._push(i)},null,"DS: Extract payload of "+r)}function De(e,t,r,n,i){var o=t.modelFor(r),s=t.peekAll(r),a=s._createSnapshot(i),u=Ember.RSVP.Promise.resolve().then(function(){return e.findAll(t,o,n,a)})
return(u=J(u,t,"DS: Handle Adapter#findAll of "+o)).then(function(n){var i=Ce(Te(t,e,r),t,o,n,null,"findAll")
return t._push(i),t._didUpdateAll(r),s},null,"DS: Extract payload of findAll ${modelName}")}function Le(e){return null==e||""===e?null:"string"==typeof e?e:""+e}function Fe(e){var t=Object.create(null)
for(var r in e)t[r]=e[r]
...
return e._query(this.modelName,t,this)},_setInternalModels:function(e,t){this.get("content").setObjects(e),this.setProperties({isLoaded:!0,isUpdating:!1,meta:Fe(t.meta),links:Fe(t.links)}),$e(e,this),Ember.run.once(this,"trigger","didLoad")}}),Ue=Ember.run.backburner,Ve=function(){function e(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._liveRecordArrays=Object.create(null),this._pending=Object.create(null),this._adapterPopulatedRecordArrays=[]}return e.prototype.recordDidChange=function(e){this.internalModelDidChange(e)},e.prototype.recordWasLoaded=function(e){this.internalModelDidChange(e)},e.prototype.internalModelDidChange=function(e){var t=e.modelName
if(!e._pendingRecordArrayManagerFlush){e._pendingRecordArrayManagerFlush=!0
var r=this._pending
1===(r[t]=r[t]||[]).push(e)&&Ue.schedule("actions",this,this._flush)}},e.prototype._flushPendingInternalModelsForModelName=function(e,t){for(var r=[],n=0;n<t.length;n++){var i=t[n]
...
function We(e){e.destroy()}function $e(e,t){for(var r=0,n=e.length;r<n;r++){e[r]._recordArrays.add(t)}}var Ke=new Ember._Backburner(["normalizeRelationships","syncRelationships","finished"]),Ye=Ember.run.backburner
function Ge(e,t){return u(e.then(function(e){return e.getRecord()}),t)}function Qe(e,t,r,n){var i=n._internalModel,o=n.modelName,s=t._modelFor(o),a=Ember.RSVP.Promise.resolve().then(function(){return e[r](t,s,n)}),u=Te(t,e,o),l="DS: Extract and notify about "+r+" completion of "+i
...
o.get(i).push(s,!1)}})}var Je=Ember.Service.extend({init:function(){this._super.apply(this,arguments),this._backburner=Ke,this.recordArrayManager=new Ve({store:this}),this._identityMap=new Se,this._pendingSave=[],this._modelFactoryCache=Object.create(null),this._relationshipsPayloads=new Ne(this),this._pendingSave=[],this._updatedRelationships=[],this._pushedInternalModels=[],this._updatedInternalModels=[],this._pendingFetch=new d({defaultValue:function(){return[]}}),this._adapterCache=Object.create(null),this._serializerCache=Object.create(null)},adapter:"-json-api",serialize:function(e,t){return e._internalModel.createSnapshot().serialize(t)},defaultAdapter:Ember.computed("adapter",function(){var e=Ember.get(this,"adapter")
...
return(u=J(u,t,"DS: Handle Adapter#findRecord of '"+a+"' with id: '"+n+"'")).then(function(i){var o=Ce(Te(t,e,a),t,r,i,n,"findRecord")
...
R[x]=A,E[x]=A.id}if(w>1)(function(e){Ie(n,r,t,E,e).then(function(t){d(t,e)}).catch(function(t){f(e,t)})})(R)
...
var r=e.modelName
this.adapterFor(r)
return this._scheduleFetch(e,t)},hasRecordForId:function(e,t){var r=x(e),n=Le(t),i=this._internalModelsFor(r).get(n)
...
return(a=Q(a=J(a,t,u),G(X,r))).then(function(r){var n=Ce(Te(t,e,i.type),t,s,r,null,"findHasMany"),o=t._push(n)
...
return(a=Q(a=J(a,t,u),G(X,r))).then(function(r){var n=Ce(Te(t,e,i.type),t,s,r,null,"findBelongsTo")
...
return e.query.length>3||e.query.wrappedFunction&&e.query.wrappedFunction.length>3?(i=i||t.recordArrayManager.createAdapterPopulatedRecordArray(r,n),a=Ember.RSVP.Promise.resolve().then(function(){return e.query(t,s,n,i,o)})):a=Ember.RSVP.Promise.resolve().then(function(){return e.query(t,s,n)}),(a=J(a,t,"DS: Handle Adapter#query of "+r)).then(function(o){var a=Ce(Te(t,e,r),t,s,o,null,"query"),u=t._push(a)
...
return(s=J(s,t,"DS: Handle Adapter#queryRecord of "+r)).then(function(n){var i=Ce(Te(t,e,r),t,o,n,null,"queryRecord")
...
r.modelName&&r.hasOwnProperty("modelName")||(r.modelName=e),this._modelFactoryCache[e]=t}return t},modelFactoryFor:function(e){var t=x(e),r=pe(this)
...
r?r=r[2]:-1!==e.source.pointer.search(j)&&(r=N),r&&(t[r]=t[r]||[],t[r].push(e.detail||e.title))}}),t},e.normalizeModelName=x,e.getOwner=pe,e.modelHasAttributeOrRelationshipNamedType=function(e){return Ember.get(e,"attributes").has("type")||Ember.get(e,"relationshipsByName").has("type")},e.coerceId=Le,e.parseResponseHeaders=function(e){var t=Object.create(null)
if(!e)return t
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default="3.2.0"}),define("ember-inflector/index",["exports","ember-inflector/lib/system","ember-inflector/lib/ext/string"],function(e,t){"use strict"
